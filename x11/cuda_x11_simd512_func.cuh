...
#define expanded_vector(x) tex1Dfetch<uint4>(d_texRef1D_128[blockIdx.x], (x))
#else
//#define expanded_vector(x) tex1Dfetch<uint4>(d_texRef1D_128[blockIdx.x], (x))
...
__device__ __forceinline__ void Round8_0(uint32_t *A, const int thr_offset,
	...
	int vec_idx = 0 + thr_offset;
	hv1 = expanded_vector(vec_idx++); w[0] = hv1.x; w[1] = hv1.y; w[2] = hv1.z; w[3] = hv1.w;
	hv2 = expanded_vector(vec_idx++); w[4] = hv2.x; w[5] = hv2.y; w[6] = hv2.z; w[7] = hv2.w;
