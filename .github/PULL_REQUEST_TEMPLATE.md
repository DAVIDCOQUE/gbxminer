...
GoByte Miner user experience or GoByte Miner developer experience
significantly:_

- _Any test improvements or new tests that improve coverage are always welcome._
- _All other changes should have accompanying unit tests (see `/unit-test/`) or
...
- _Features are welcome, but might be rejected due to design or scope issues.
  ...
  consider building the system outside of GoByte Miner, if possible._
