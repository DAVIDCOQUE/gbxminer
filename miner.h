...
extern int scanhash_zelhash(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done);
extern int scanhash_kawpow(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done);
extern int scanhash_kheavyhash(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done);
...
extern void free_zelhash(int thr_id);
extern void free_kawpow(int thr_id);
extern void free_kheavyhash(int thr_id);
