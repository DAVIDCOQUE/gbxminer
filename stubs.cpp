...
int scanhash_heavy(int thr_id, struct work *work, uint32_t max_nonce, unsigned long *hashes_done, uint32_t maxvote, int blocklen) { return 0; }
...
int scanhash_sha256d(int thr_id, struct work *work, uint32_t max_nonce, unsigned long *hashes_done) { return 0; }
...
void fugue256_hash(void* output, const void* input, int len) { }
...
bool equi_stratum_notify(struct stratum_ctx *sctx, json_t *params) { return true; }
...
double equi_network_diff(struct work *work) { return 1.0; }
